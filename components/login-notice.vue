      ...
      <div class="weui-dialog">
        <div class="weui-dialog__hd title">
          ...
          <strong class="weui-dialog__title">
            {{ state.class != "alive" ? "糟糕，京东账号不在登录状态" : "太好了，账号登录状态有效"}}
          </strong>
        </div>
            ...
            <div class="weui-cells">
              <a data-url="https://passport.jd.com/uc/login" v-tippy :class="`${state['pc'].state} login-type_pc`" :title="state['pc'].description">
                <div class="weui-cell">
                  ...
                  <div class="weui-cell__ft login-status" style="font-size: 0">
                    <span style="vertical-align:middle; font-size: 17px;" class="status-text">{{stateText[state['pc'].state]}}</span>
              ...
              <a data-url="https://wqs.jd.com/my/indexv2.shtml" v-tippy :class="`${state['m'].state} login-type_m openMobilePage`" :title="state['pc'].description">
                <div class="weui-cell">
                  ...
                  <div class="weui-cell__ft login-status" style="font-size: 0">
                    <span style="vertical-align:middle; font-size: 17px;" class="status-text">{{stateText[state['m'].state]}}</span>
